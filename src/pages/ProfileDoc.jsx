        ...
        <div className="doc-settings-grid">
          <div className="left-s">
            ...
            <div className="input-2">
              ...
              <input type="text" className="first" name="firstName" onChange={handleInputs} placeholder="First Name" />
            </div>
            ...
            <div className="input-5">
              ...
              <input type="text" className="address" name="address" placeholder="Address" onChange={handleInputs} />
            </div>
          ...
          <div className="right-s">
            ...
            <div className="input-4">
              <i className="ri-user-line"></i>
              <input type="text" className="last" name="lastName" onChange={handleInputs} placeholder="Last Name" />
            </div>
            ...
            <div className="input-1">
              <i className="ri-user-line"></i>
              <input type="text" className="age" name="age" onChange={handleInputs} placeholder="Age" />
            </div>
